...
Example:
    ...
    Elegant drama underscore. Soft grand piano, warm strings, light pizzicato
    pulse. Poised tension, 78 BPM, minor. A candlelit restaurant under
    chandeliers, glasses clinking far away. No vocals, instrumental only.
...
6. Match the channel's register: an elegant luxury-drama score — grand piano,
   warm strings, a light pulse; poised tension while the hero is mocked, warm
   and satisfying at the reveal. Never horror, never a triumphant fanfare.
