...
DE_BAI_GAN = (
    ...
    "═══ TRƯỚC HẾT: ĐỌC XEM TIÊU ĐỀ NÀY NÓI VỀ AI ═══\n\n"
    "Phần lớn tiêu đề trong ngách này nêu một ĐẶC ĐIỂM hoặc THÓI QUEN "
    "(\"đặc điểm của người…\", \"tâm lý của người…\"). Với chúng, đường đi "
    "chỉ có hai bước: **ai mang đặc điểm ấy**, rồi **người ấy nằm ở tệp "
    "nào**. Đặc điểm là cửa vào, không phải chủ đề.\n\n"
    "  \"người thích ở một mình\"        -> người sống lệch nhịp số đông\n"
    "  \"người không dùng mạng xã hội\"  -> cũng người ấy\n"
    "  \"người không thể mở lòng với ai\" -> cũng người ấy\n"
    "  \"người hay quên tên\"            -> người đang lo mình già đi\n\n"
    "Ba cái đầu là cùng MỘT người: ai cũng bảo phải hoà đồng, họ thì không, "
    "và họ bấm vào để xem mình có sao không. Chữ nghĩa khác nhau, người thì "
    "một.\n\n"
    "⚠ Ngược lại, tiêu đề chỉ bán một MẸO hay một bài tự-giúp chung — "
    "\"10 thói quen tái thiết kế não bộ\", \"chiến lược tất thắng\", "
